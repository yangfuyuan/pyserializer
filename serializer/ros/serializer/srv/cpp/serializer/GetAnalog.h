/* auto-generated by gensrv_cpp from /home/patrick/Eclipse/serializer/src/ros/serializer/srv/GetAnalog.srv.  Do not edit! */
#ifndef SRV_SERIALIZER_GETANALOG_H
#define SRV_SERIALIZER_GETANALOG_H
...
inline static std::string getDataType() { return "serializer/GetAnalog"; }
...
public:
  ...
  inline static std::string __s_getDataType() { return std::string("serializer/GetAnalogRequest"); }
  ...
  inline static std::string __s_getServiceDataType() { return std::string("serializer/GetAnalog"); }
...
public:
  ...
  inline static std::string __s_getDataType() { return std::string("serializer/GetAnalogResponse"); }
  inline static std::string __s_getMD5Sum() { return std::string(""); }
  inline static std::string __s_getMessageDefinition()
  {
    return std::string(
